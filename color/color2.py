...
The available colors from the crayons package are: red, green, yellow, blue, black, magenta, cyan, and white. 
Write a line at the end that prints your name in (at least) two colors.
